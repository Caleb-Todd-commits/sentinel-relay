  ...
  "timeline": [
    {
      ...
      "summary": "Band Leader creates the Band incident room and recruits specialist agents.",
      "evidenceIds": [],
    ...
    },
    {
      ...
      "summary": "Band Leader compiles the traceable incident report with evidence, challenge, approval, and remediation context.",
      "evidenceIds": [
        "ev-api-spike",
        "ev-code-diff",
        "ev-policy-approval"
